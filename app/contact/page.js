              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://instagram.com/khyontek.ai" target="_blank" rel="noopener noreferrer" className="text-dark-navy font-semibold hover:text-royal-blue transition-colors">@khyontek.ai</a>
                  </div>
                </div>
              </div>
            </div>
